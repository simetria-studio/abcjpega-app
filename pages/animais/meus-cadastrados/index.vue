  ...
  <div class="my-8">
    ...
    <form action="">
      <div class="relative mx-auto w-72 py-4">
        ...
        <button type="submit"
          class="absolute inset-y-0 right-0 focus:text-red-900  flex items-center pr-3  ">
          <svg aria-hidden="true" class="w-5 h-5 text-zinc-500 hover:text-red-900" fill="currentColor" viewBox="0 0 20 20"
