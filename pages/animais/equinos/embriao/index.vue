<template>
    <div>
      ...
      <component
        ...
        v-bind:formEmbriaoEquino="formEmbriaoEquino[steps[currentStep].label]"
      />
  ...
  <script>
  import identificacaoEmbriaoEquino from "./steps/identificacao";
  import motivoEmbriaoEquino from "./steps/motivo";
  ...
  export default {
    ...
    data() {
      return {
        currentStep: 0,
        formEmbriaoEquino: {
          identificacaoEmbriaoEquino: {},
          motivoEmbriaoEquino: {},
        },
        steps: [
          {
            components: identificacaoEmbriaoEquino,
          },
          {
            components: motivoEmbriaoEquino,
          },
        ],
      };
    },
