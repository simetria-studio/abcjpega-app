    ...
    <div>
        ...
        <div class="mb-4">
            <div class="w-60 mx-auto">
                ...
                <div class="bg-zinc-200 h-52 w-full rounded-lg p-4 overflow-y-auto mb-5 ">
                ...
                <div class="text-center">
                    <button type="submit" class="mt-4 border border-red-900 rounded p-1 px-4 bg-red-900 text-white hover:bg-red-800  focus:outline-none focus:border-red-900 focus:ring focus:ring-red-200">Solicitar</button>
                </div>
            </div>
        </div>
