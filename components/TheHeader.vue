          ...
          <nav v-show="navOpen">
            <div class="sidemenu__wrapper bg-red-900">
              <ul class="sidemenu__list">
                ...
                <li class="sidemenu__item"><a href="">Meu Perfil</a></li>
                <li class="sidemenu__item"><a href="">Canais de comunicação</a></li>
                <li class="sidemenu__item"><a href="">Informativos</a></li>
                <li class="sidemenu__item"><a href="">Solicitações</a></li>
                <li class="sidemenu__item"><a href="">Sair</a></li>
              </ul>
            </div>
          </nav>
        </transition>
